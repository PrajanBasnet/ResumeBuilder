            ...
            {SummaryVision ?
                <MainTheme visible={SummaryVision} setVisible={setSummary} label={summaryStatic.label} height={summaryStatic.height} >
                    <div>
                        ...
                        <textarea name="Text" id="" cols="28" rows="10" className=" border p-2 " value={data.profession.desc}  onChange={(e) => setData.setProfessionSummary({...data.profession,desc:e.target.value})} ></textarea>
                    </div>
